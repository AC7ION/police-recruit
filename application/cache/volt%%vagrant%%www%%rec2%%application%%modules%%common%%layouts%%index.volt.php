        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li <?php echo (($uri == '/frontend/candidates/list/') ? ' class="active"' : ''); ?>>
                        <a href="/frontend/candidates/list/">Кандидати</a>
                    </li>
                    <li <?php echo (($uri == '/frontend/vacancies/list/') ? ' class="active"' : ''); ?>>
                        <a href="/frontend/vacancies/list/">Вакансії</a>
                    </li>
                    <li>
                        <a href="#">Статистика</a>
                    </li>
                    <li <?php echo (($uri == '/frontend/index/about') ? ' class="active"' : ''); ?>>
